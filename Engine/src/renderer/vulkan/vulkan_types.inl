...
// Check if given expression return value agains VK_SUCCESS
...
typedef struct vulkan_swapchain {
  ...
  //framebuffers used for on-screen renderign
...
typedef struct vulkan_context {
  ...
  // Holds pointers to fences which exist and are of semaphores
