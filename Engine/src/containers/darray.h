...
SLAPI void* _darray_create(u64 length, u64 stride);
SLAPI void _darray_destroy(void* array);

SLAPI u64 _darray_field_get(void* array, u64 field);
SLAPI void _darray_field_set(void* array, u64 field, u64 value);

SLAPI void* _darray_resize(void* array);

SLAPI void* _darray_push(void* array, const void* value_ptr);
SLAPI void _darray_pop(void* array, void* dest);

SLAPI void* _darray_insert_at(void* array, u64 index, const void* value_ptr);
SLAPI void* _darray_pop_at(void* array, u64 index, void* dest);
...
#define darray_inster_at(array, index, value) {    \
  typeof(value) temp = value;          \
  array = _darray_insert_at(array, index, &tempp); \
}
